  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-[45%] md:top-auto md:bottom-0 left-[55%] md:left-[58%] -translate-x-1/2 -translate-y-1/2 md:translate-y-0 w-[280px] sm:w-[400px] md:w-[500px] h-[380px] sm:h-[480px] md:h-[550px] z-0 pointer-events-none select-none">
          <motion.div

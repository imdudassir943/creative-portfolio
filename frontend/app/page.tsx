...
const FeaturedProjectCard: React.FC<FeaturedProjectCardProps> = ({ project, i }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative aspect-[4/5] sm:aspect-[4/3] rounded-2xl overflow-hidden cursor-pointer p-[1.5px] bg-dark-800/40 border border-dark-700/30 shadow-lg"
    >
